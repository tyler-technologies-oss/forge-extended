var u=r=>{throw TypeError(r)};var m=(r,t,e)=>t.has(r)||u("Cannot "+e);var a=(r,t,e)=>(m(r,t,"read from private field"),e?e.call(r):t.get(r)),y=(r,t,e)=>t.has(r)?u("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(r):t.set(r,e);var l=(r,t,e)=>(m(r,t,"access private method"),e);import{i as N,r as F,x as n}from"./iframe-Qh6uGKis.js";import{n as x}from"./query-assigned-nodes-cwDSNLIu.js";import{n as k}from"./when-3fO0zp9C.js";import{t as C}from"./component-utils-CHSR0lNw.js";import{h as d}from"./lit-utils-CcR0cCgf.js";const H=`/**
 * @license
