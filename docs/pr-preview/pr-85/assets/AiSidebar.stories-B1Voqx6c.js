import{x as d}from"./iframe-xC0vBhGT.js";import{I as c,d as p,e as l,f,g,h as m,i as h,j as u}from"./icon-registry-ChndCm7L.js";import{d as y}from"./ai-sidebar-CRslG_Gg.js";import"./ai-chat-interface-zaFKD1Ir.js";import"./ai-user-message-AJZNknsz.js";import"./ai-response-message-CSft-2IM.js";import"./ai-button-DwFOHH5b.js";import{d as b}from"./index-BxLETMcb.js";import{d as I}from"./index-DUP2eTTC.js";const{action:r}=__STORYBOOK_MODULE_ACTIONS__;y();b();I();c.define([p,l,f,g,m,h,u]);const w="forge-ai-sidebar",x={title:"AI/Primitives/Sidebar",component:w,argTypes:{open:{control:{type:"boolean"},description:"Controls whether the sidebar is open"},expanded:{control:{type:"boolean"},description:"Controls whether the sidebar is displayed in an expanded state"}},args:{open:!1,expanded:!1},render:a=>{const t=r("forge-ai-sidebar-open"),i=r("forge-ai-sidebar-close"),s=()=>{const e=document.querySelector("forge-ai-chat-interface");e&&(e.expanded=!e.expanded)},n=()=>{document.querySelector("forge-ai-sidebar")?.close()};return d`
