import{x as t}from"./iframe-BQrsiEyh.js";import{I as r,n as c,o as a,m as s,d as i,p as m}from"./icon-registry-DH_mpcNN.js";import"./multi-select-header-C_Agb0ZH.js";import{d}from"./index-CbewkrZA.js";import{d as f}from"./index-DeQitNSN.js";import{d as p}from"./index-uzjtOGgK.js";const{action:u}=__STORYBOOK_MODULE_ACTIONS__;d();f();p();r.define([c,a,s,i,m]);const g="forge-multi-select-header",x={title:"Components/Multi Select Header",component:g,render:o=>{const n=u("forge-multi-select-header-select-all"),l=[{label:"Export as a PDF",value:"option-1",icon:"file_pdf",leadingIconType:"component"},{label:"Export to Excel",value:"option-2",icon:"file_excel",leadingIconType:"component"}];return t`
