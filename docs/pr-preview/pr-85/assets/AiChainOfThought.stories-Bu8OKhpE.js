 ...
 */:host{display:block}.image-container{--forge-card-outline-color: transparent;display:grid;place-content:center;place-items:center}::slotted(img[slot=image]){height:150px;width:150px;object-fit:cover;border-radius:calc(var(--forge-shape-medium, 4px) * var(--forge-shape-factor, 1))}`;var E=Object.defineProperty,W=Object.getOwnPropertyDescriptor,T=(e,t,r,a)=>{for(var o=a>1?void 0:a?W(t,r):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(o=(a?i(t,r,o):i(o))||o);return a&&o&&E(t,r,o),o};const F="forge-ai-thought-image";let v=class extends u{render(){return s`
    ...
    `}};v.styles=g(R);T([d({type:Number})],v.prototype,"step",2);v=T([f(F)],v);const Y=":host{display:block}";var Z=Object.getOwnPropertyDescriptor,J=(e,t,r,a)=>{for(var o=a>1?void 0:a?Z(t,r):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(o=i(o)||o);return o};const K="forge-ai-thought-detail";let y=class extends u{render(){return s`
      <forge-ai-thought-base>
        <svg slot="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="forge-icon">
    ...
    `}};y.styles=g(Y);y=J([f(K)],y);const Q="forge-ai-chain-of-thought",$=[{title:"Powder Safety Guide",href:"https://example.com/safety-guide"},{title:"Equipment Reviews 2024",href:"https://example.com/equipment-reviews"}],$o={title:"AI/Primitives/Chain of Thought",component:Q,render:()=>s`
...
}`,...b.parameters?.docs?.source}}};const Ao=["Demo","InChatInterface"];export{p as Demo,b as InChatInterface,Ao as __namedExportsOrder,$o as default};
