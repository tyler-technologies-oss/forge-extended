import{x as i}from"./iframe-BRtv1zRu.js";import"./ai-prompt-DIKvfX2R.js";import"./prompt-button-BBAfdCBv.js";import"./ai-dropdown-menu-DjUs4lUW.js";import"./ai-voice-input-C1wGUwAa.js";import{I as p,e as s,c as d,a as c,t as m}from"./icon-registry-Bm1g41-E.js";import{d as l}from"./index-DPsxYezB.js";const{action:g}=__STORYBOOK_MODULE_ACTIONS__;l();p.define([s,d,c,m]);const f="forge-ai-prompt",u={title:"AI/Primitives/Prompt",component:f,argTypes:{variant:{control:"select",options:["stacked","inline"],description:"Layout variant for the prompt component"},placeholder:{control:"text",description:"Placeholder text for the input field"}},args:{variant:"stacked",placeholder:"Ask a question..."},render:e=>{const t=g("forge-ai-prompt-send"),r=a=>{const n=document.querySelector("forge-ai-prompt");n&&(n.value=a.detail.transcript)};return i`
