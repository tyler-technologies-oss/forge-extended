import{e as l,i as c,c as v}from"./iframe-BD-GhVd2.js";import{B as h,a as m,_ as b,c as g,d as p}from"./with-default-aria-BuVAC_q5.js";import{C as u}from"./icon-registry-DssWwa3j.js";/**
 * @license
 ...
 * Copyright Tyler Technologies, Inc. 
 * License: Apache-2.0
 */const C='<template><div class="forge-divider" part="root"></div></template>',_=":host{--_divider-margin:var(--forge-divider-margin, 0)}:host{display:block;margin:var(--_divider-margin)}:host([hidden]){display:none}.forge-divider{--_divider-color:var(--forge-divider-color, var(--forge-theme-outline, #e0e0e0));--_divider-width:var(--forge-divider-width, var(--forge-border-thin, 1px));--_divider-border-style:var(--forge-divider-border-style, solid)}.forge-divider{border:none;border-bottom-color:var(--_divider-color);border-bottom-width:var(--_divider-width);border-bottom-style:var(--_divider-border-style);height:0}:host([vertical]){display:inline-block;height:100%}:host([vertical]) .forge-divider{border:none;border-right-color:var(--_divider-color);border-right-width:var(--_divider-width);border-right-style:var(--_divider-border-style);height:100%;width:0}";let s=class extends h{static get observedAttributes(){return[o.attributes.VERTICAL]}constructor(){super(),m(this,C,_)}attributeChangedCallback(e,t,i){switch(e){case o.attributes.VERTICAL:this.vertical=v(i);break}}get vertical(){return this.hasAttribute(o.attributes.VERTICAL)}set vertical(e){this.toggleAttribute(o.attributes.VERTICAL,e)}};s=b([g({name:o.elementName})],s);/**
 * @license
 * Copyright Tyler Technologies, Inc. 
 * License: Apache-2.0
