 ...
 */:host{display:block}.image-container{--forge-card-outline-color: transparent;display:grid;place-content:center;place-items:center}::slotted(img[slot=image]){height:150px;width:150px;object-fit:cover;border-radius:calc(var(--forge-shape-medium, 4px) * var(--forge-shape-factor, 1))}`;var I=Object.defineProperty,L=Object.getOwnPropertyDescriptor,k=(t,e,i,r)=>{for(var o=r>1?void 0:r?L(e,i):e,a=t.length-1,n;a>=0;a--)(n=t[a])&&(o=(r?n(e,i,o):n(o))||o);return r&&o&&I(e,i,o),o};const V="forge-ai-thought-image";let v=class extends b{render(){return s`
    ...
    `}};v.styles=f(M);k([d({type:Number})],v.prototype,"step",2);v=k([p(V)],v);const N=":host{display:block}";var G=Object.getOwnPropertyDescriptor,R=(t,e,i,r)=>{for(var o=r>1?void 0:r?G(e,i):e,a=t.length-1,n;a>=0;a--)(n=t[a])&&(o=n(o)||o);return o};const W="forge-ai-thought-detail";let m=class extends b{render(){return s`
      <forge-ai-thought-base>
        <svg slot="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="forge-icon">
    ...
    `}};m.styles=f(N);m=R([p(W)],m);const F="forge-ai-chain-of-thought",z=[{title:"Powder Safety Guide",href:"https://example.com/safety-guide"},{title:"Equipment Reviews 2024",href:"https://example.com/equipment-reviews"}],Y={title:"AI/Primitives/Chain of Thought",component:F,tags:["autodocs"],argTypes:{expanded:{control:"boolean",description:"Whether the chain of thought is expanded"},title:{control:"text",description:"Title for the chain of thought section"}},args:{expanded:!1,title:"Chain of Thought"},render:t=>s`
...
}`,...c.parameters?.docs?.source}}};const E=["Demo","InChatInterface"],ro=Object.freeze(Object.defineProperty({__proto__:null,Demo:l,InChatInterface:c,__namedExportsOrder:E,default:Y},Symbol.toStringTag,{value:"Module"}));export{ro as A,l as D};
