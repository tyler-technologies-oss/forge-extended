import{x as d}from"./iframe-CreInDM6.js";import{I as c,f as p,g as l,h as f,i as g,j as m,k as h,l as u}from"./icon-registry-CwmqUg58.js";import{d as y}from"./ai-sidebar-BiHoF3jm.js";import"./ai-chat-interface-D4whn_q8.js";import"./ai-user-message-B4Scg9G2.js";import"./ai-response-message-KcxcopVe.js";import"./ai-button-Cgc6i2lP.js";import{d as b}from"./index-Ct1nLHLf.js";import{d as I}from"./index-BfqEnro2.js";const{action:r}=__STORYBOOK_MODULE_ACTIONS__;y();b();I();c.define([p,l,f,g,m,h,u]);const w="forge-ai-sidebar",x={title:"AI/Primitives/Sidebar",component:w,argTypes:{open:{control:{type:"boolean"},description:"Controls whether the sidebar is open"},expanded:{control:{type:"boolean"},description:"Controls whether the sidebar is displayed in an expanded state"}},args:{open:!1,expanded:!1},render:a=>{const t=r("forge-ai-sidebar-open"),i=r("forge-ai-sidebar-close"),s=()=>{const e=document.querySelector("forge-ai-chat-interface");e&&(e.expanded=!e.expanded)},n=()=>{document.querySelector("forge-ai-sidebar")?.close()};return d`
