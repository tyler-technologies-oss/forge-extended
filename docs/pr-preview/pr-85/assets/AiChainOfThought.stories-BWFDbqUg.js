 ...
 */@keyframes fadeIn{0%{opacity:0}to{opacity:1}}:host{display:block;opacity:0;animation:fadeIn .25s ease-in-out forwards}.sources-container{display:flex;align-items:center;column-gap:var(--forge-spacing-small, 12px);row-gap:var(--forge-spacing-xxsmall, 4px);flex-wrap:wrap;margin-block-start:var(--forge-spacing-xsmall, 8px)}.source{-moz-osx-font-smoothing:grayscale;-webkit-font-smoothing:antialiased;font-family:var(--forge-typography-button-font-family, var(--forge-typography-font-family, "Roboto", sans-serif));font-size:var(--forge-typography-button-font-size, calc(var(--forge-typography-font-size, 1rem) * var(--forge-typography-button-font-size-scale, .875)));font-weight:var(--forge-typography-button-font-weight, 500);line-height:var(--forge-typography-button-line-height, normal);letter-spacing:var(--forge-typography-button-letter-spacing, .0714285714em);text-transform:var(--forge-typography-button-text-transform, inherit);text-decoration:var(--forge-typography-button-text-decoration, inherit);display:flex;align-items:center;gap:var(--forge-spacing-xsmall, 8px);border-radius:calc(var(--forge-shape-medium, 4px) * var(--forge-shape-factor, 1));background-color:var(--forge-theme-surface-container, #e0e0e0);padding-inline:var(--forge-spacing-medium, 16px);padding-block:var(--forge-spacing-xxsmall, 4px);color:var(--forge-theme-text-high, rgba(0, 0, 0, .87));cursor:pointer}.source svg{height:16px;width:16px}`;var R=Object.defineProperty,V=Object.getOwnPropertyDescriptor,_=(a,r,n,e)=>{for(var t=e>1?void 0:e?V(r,n):r,i=a.length-1,o;i>=0;i--)(o=a[i])&&(t=(e?o(r,n,t):o(t))||t);return e&&t&&R(r,n,t),t};const N="forge-ai-thought-search-result";let g=class extends p{constructor(){super(...arguments),this.sources=[]}render(){return s`
    ...
    `}};g.styles=u(B);_([h({type:Number})],g.prototype,"step",2);_([h({type:Array})],g.prototype,"sources",2);g=_([f(N)],g);const G=`/**
 * @license
 * Copyright Tyler Technologies, Inc. 
 * License: Apache-2.0
 */@keyframes fadeIn{0%{opacity:0}to{opacity:1}}:host{display:block;opacity:0;animation:fadeIn .25s ease-in-out forwards}.image-container{--forge-card-outline-color: transparent;display:grid;place-content:center;place-items:center}::slotted(img[slot=image]){height:150px;width:150px;object-fit:cover;border-radius:calc(var(--forge-shape-medium, 4px) * var(--forge-shape-factor, 1))}`;var F=Object.defineProperty,W=Object.getOwnPropertyDescriptor,z=(a,r,n,e)=>{for(var t=e>1?void 0:e?W(r,n):r,i=a.length-1,o;i>=0;i--)(o=a[i])&&(t=(e?o(r,n,t):o(t))||t);return e&&t&&F(r,n,t),t};const K="forge-ai-thought-image";let m=class extends p{render(){return s`
      <forge-ai-thought-base step=${x(this.step)}>
        <svg slot="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="forge-icon">
          <path
    ...
    `}};m.styles=u(G);z([h({type:Number})],m.prototype,"step",2);m=z([f(K)],m);const Y=`/**
 * @license
 * Copyright Tyler Technologies, Inc. 
 * License: Apache-2.0
 */@keyframes fadeIn{0%{opacity:0}to{opacity:1}}:host{display:block;opacity:0;animation:fadeIn .25s ease-in-out forwards}`;var Z=Object.getOwnPropertyDescriptor,J=(a,r,n,e)=>{for(var t=e>1?void 0:e?Z(r,n):r,i=a.length-1,o;i>=0;i--)(o=a[i])&&(t=o(t)||t);return t};const Q="forge-ai-thought-detail";let y=class extends p{render(){return s`
      <forge-ai-thought-base>
        <svg slot="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="forge-icon">
    ...
    `}};y.styles=u(Y);y=J([f(Q)],y);const U="forge-ai-chain-of-thought";$();M();q();A.define([S,C]);const T=[{title:"Powder Safety Guide",href:"https://example.com/safety-guide"},{title:"Equipment Reviews 2024",href:"https://example.com/equipment-reviews"}],X=()=>s`
  ...
  `,tt={title:"AI/Primitives/Chain of Thought",component:U,tags:["autodocs"],argTypes:{expanded:{control:"boolean",description:"Whether the chain of thought is expanded"}},args:{expanded:!1},render:a=>s`
...
}`,...c.parameters?.docs?.source}}};const et=["Demo","InChatInterface","SequentialLoading"],mt=Object.freeze(Object.defineProperty({__proto__:null,Demo:d,InChatInterface:l,SequentialLoading:c,__namedExportsOrder:et,default:tt},Symbol.toStringTag,{value:"Module"}));export{mt as A,d as D};
