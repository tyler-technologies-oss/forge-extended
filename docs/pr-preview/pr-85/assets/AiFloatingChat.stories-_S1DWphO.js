import{r as $,i as S,x as r}from"./iframe-BD_Clzv8.js";import{t as F}from"./custom-element-BhZVzxrc.js";import{n as y}from"./property-BuRkmpuX.js";import{r as E}from"./state-BI0ZEGaT.js";import{n as A,e as T}from"./ref-CYnz7duC.js";import"./ai-dialog-AFecp7X8.js";import"./ai-chat-interface-CzSilqj5.js";import"./ai-user-message-2J0ocYKq.js";import"./ai-response-message-s_tFVEel.js";import"./ai-fab-button-O7xQtjqV.js";const I=":host{display:block}";var k=Object.defineProperty,z=Object.getOwnPropertyDescriptor,w=e=>{throw TypeError(e)},f=(e,t,o,l)=>{for(var i=l>1?void 0:l?z(t,o):t,u=e.length-1,m;u>=0;u--)(m=e[u])&&(i=(l?m(t,o,i):m(i))||i);return l&&i&&k(t,o,i),i},v=(e,t,o)=>t.has(e)||w("Cannot "+o),g=(e,t,o)=>(v(e,t,"read from private field"),o?o.call(e):t.get(e)),x=(e,t,o)=>t.has(e)?w("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,o),a=(e,t,o)=>(v(e,t,"access private method"),o),h,n,b,_,C,s;const B="forge-ai-floating-chat";let p=class extends S{constructor(){super(...arguments),x(this,n),this.open=!1,this.expanded=!1,this._isFullscreen=!1,x(this,h,T())}updated(){g(this,h).value&&this._isFullscreen!==g(this,h).value.isFullscreen&&(this._isFullscreen=g(this,h).value.isFullscreen)}render(){return r`
      <forge-ai-dialog
        ${A(g(this,h))}
        ?open=${this.open}
