import{r as F,i as S,x as l}from"./iframe-Nf4WLXYm.js";import{t as E}from"./custom-element-BhZVzxrc.js";import{n as y}from"./property-76qi75lb.js";import{r as T}from"./state-eHWx9GP1.js";import{n as A,e as I}from"./ref-BLBcJiBs.js";import"./ai-dialog-CS5Cec4i.js";import"./ai-chat-interface-BRJVDfFo.js";import"./ai-user-message-Bb5DlH1t.js";import"./ai-response-message-DgnDbfaK.js";import"./ai-fab-DpjWA0xP.js";import"./ai-suggestions-BrjUIGLH.js";const H=":host{display:block}";var z=Object.defineProperty,k=Object.getOwnPropertyDescriptor,v=e=>{throw TypeError(e)},f=(e,t,o,r)=>{for(var a=r>1?void 0:r?k(t,o):t,u=e.length-1,m;u>=0;u--)(m=e[u])&&(a=(r?m(t,o,a):m(a))||a);return r&&a&&z(t,o,a),a},w=(e,t,o)=>t.has(e)||v("Cannot "+o),d=(e,t,o)=>(w(e,t,"read from private field"),o?o.call(e):t.get(e)),x=(e,t,o)=>t.has(e)?v("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,o),n=(e,t,o)=>(w(e,t,"access private method"),o),c,s,_,b,$,C,i;const O="forge-ai-floating-chat";let h=class extends S{constructor(){super(...arguments),x(this,s),this.open=!1,this.expanded=!1,this._isFullscreen=!1,x(this,c,I())}updated(){d(this,c).value&&this._isFullscreen!==d(this,c).value.isFullscreen&&(this._isFullscreen=d(this,c).value.isFullscreen)}render(){return l`
      <forge-ai-dialog
        ${A(d(this,c))}
        ?open=${this.open}
