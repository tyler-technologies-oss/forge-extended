 ...
 */:host{display:block}.sources-container{display:flex;align-items:center;column-gap:var(--forge-spacing-small, 12px);row-gap:var(--forge-spacing-xxsmall, 4px);flex-wrap:wrap;margin-block-start:var(--forge-spacing-xsmall, 8px)}.source{-moz-osx-font-smoothing:grayscale;-webkit-font-smoothing:antialiased;font-family:var(--forge-typography-button-font-family, var(--forge-typography-font-family, "Roboto", sans-serif));font-size:var(--forge-typography-button-font-size, calc(var(--forge-typography-font-size, 1rem) * var(--forge-typography-button-font-size-scale, .875)));font-weight:var(--forge-typography-button-font-weight, 500);line-height:var(--forge-typography-button-line-height, normal);letter-spacing:var(--forge-typography-button-letter-spacing, .0714285714em);text-transform:var(--forge-typography-button-text-transform, inherit);text-decoration:var(--forge-typography-button-text-decoration, inherit);display:flex;align-items:center;gap:var(--forge-spacing-xsmall, 8px);border-radius:calc(var(--forge-shape-medium, 4px) * var(--forge-shape-factor, 1));background-color:var(--forge-theme-surface-container, #e0e0e0);padding-inline:var(--forge-spacing-medium, 16px);padding-block:var(--forge-spacing-xxsmall, 4px);color:var(--forge-theme-text-high, rgba(0, 0, 0, .87));cursor:pointer}.source svg{height:16px;width:16px}`;var V=Object.defineProperty,N=Object.getOwnPropertyDescriptor,_=(e,t,a,r)=>{for(var o=r>1?void 0:r?N(t,a):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(o=(r?i(t,a,o):i(o))||o);return r&&o&&V(t,a,o),o};const R="forge-ai-thought-search-result";let g=class extends u{constructor(){super(...arguments),this.sources=[]}render(){return s`
    ...
    `}};g.styles=c(L);_([p({type:Number})],g.prototype,"step",2);_([p({type:Array})],g.prototype,"sources",2);g=_([f(R)],g);const G=`/**
 * @license
 * Copyright Tyler Technologies, Inc. 
 * License: Apache-2.0
 */:host{display:block}.image-container{--forge-card-outline-color: transparent;display:grid;place-content:center;place-items:center}::slotted(img[slot=image]){height:150px;width:150px;object-fit:cover;border-radius:calc(var(--forge-shape-medium, 4px) * var(--forge-shape-factor, 1))}`;var F=Object.defineProperty,E=Object.getOwnPropertyDescriptor,k=(e,t,a,r)=>{for(var o=r>1?void 0:r?E(t,a):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(o=(r?i(t,a,o):i(o))||o);return r&&o&&F(t,a,o),o};const W="forge-ai-thought-image";let v=class extends u{render(){return s`
    ...
    `}};v.styles=c(G);k([p({type:Number})],v.prototype,"step",2);v=k([f(W)],v);const Y=":host{display:block}";var Z=Object.getOwnPropertyDescriptor,J=(e,t,a,r)=>{for(var o=r>1?void 0:r?Z(t,a):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(o=i(o)||o);return o};const K="forge-ai-thought-detail";let m=class extends u{render(){return s`
      <forge-ai-thought-base>
        <svg slot="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="forge-icon">
    ...
    `}};m.styles=c(Y);m=J([f(K)],m);const Q="forge-ai-chain-of-thought";A();D();O();C.define([T,$]);const z=[{title:"Powder Safety Guide",href:"https://example.com/safety-guide"},{title:"Equipment Reviews 2024",href:"https://example.com/equipment-reviews"}],U=()=>s`
  ...
  `,X={title:"AI/Primitives/Chain of Thought",component:Q,tags:["autodocs"],argTypes:{expanded:{control:"boolean",description:"Whether the chain of thought is expanded"}},args:{expanded:!1},render:e=>s`
      <forge-ai-chain-of-thought .expanded=${e.expanded}>
        <forge-ai-reasoning-header slot="heading" .expanded=${e.expanded}>
...
}`,...l.parameters?.docs?.source}}};const oo=["Demo","InChatInterface"],mo=Object.freeze(Object.defineProperty({__proto__:null,Demo:d,InChatInterface:l,__namedExportsOrder:oo,default:X},Symbol.toStringTag,{value:"Module"}));export{mo as A,d as D};
