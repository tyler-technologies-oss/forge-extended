import{x as n}from"./iframe-C89uLCYv.js";import"./ai-chat-header-BSlxywY8.js";import{d as f}from"./index-BRnyG7RK.js";import{d as m}from"./index-BSVsUUir.js";const{action:c}=__STORYBOOK_MODULE_ACTIONS__,l="forge-ai-chat-header",d=c("forge-ai-chat-header-expand"),h=c("forge-ai-chat-header-minimize"),s=c("forge-ai-chat-header-clear"),g=c("forge-ai-chat-header-info");f();m();const p={title:"AI/Primitives/Chat Header",component:l,argTypes:{title:{control:"text",description:"The title text to display in the header"}},args:{title:"AI Assistant"},render:e=>n`
