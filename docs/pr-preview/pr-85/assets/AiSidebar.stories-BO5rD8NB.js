import{x as d}from"./iframe-Cq-laB_0.js";import{I as c,t as p,a as l,b as f,c as g,d as m,e as h,f as u}from"./icon-registry-QJlQPQoC.js";import{d as y}from"./ai-sidebar-Bg_0GnmN.js";import"./ai-chat-interface-B4QexkZg.js";import"./ai-user-message-CQPL8Dcz.js";import"./ai-response-message-BzoKWm9m.js";import"./ai-button-CvDgtmaA.js";import{d as b}from"./index-D__56Mct.js";import{d as I}from"./index-Cb4d6jIT.js";const{action:r}=__STORYBOOK_MODULE_ACTIONS__;y();b();I();c.define([p,l,f,g,m,h,u]);const w="forge-ai-sidebar",x={title:"AI/Primitives/Sidebar",component:w,argTypes:{open:{control:{type:"boolean"},description:"Controls whether the sidebar is open"},expanded:{control:{type:"boolean"},description:"Controls whether the sidebar is displayed in an expanded state"}},args:{open:!1,expanded:!1},render:a=>{const t=r("forge-ai-sidebar-open"),i=r("forge-ai-sidebar-close"),s=()=>{const e=document.querySelector("forge-ai-chat-interface");e&&(e.expanded=!e.expanded)},n=()=>{document.querySelector("forge-ai-sidebar")?.close()};return d`
