 ...
 */:host{display:block}.sources-container{display:flex;align-items:center;column-gap:var(--forge-spacing-small, 12px);row-gap:var(--forge-spacing-xxsmall, 4px);flex-wrap:wrap;margin-block-start:var(--forge-spacing-xsmall, 8px)}.source{-moz-osx-font-smoothing:grayscale;-webkit-font-smoothing:antialiased;font-family:var(--forge-typography-button-font-family, var(--forge-typography-font-family, "Roboto", sans-serif));font-size:var(--forge-typography-button-font-size, calc(var(--forge-typography-font-size, 1rem) * var(--forge-typography-button-font-size-scale, .875)));font-weight:var(--forge-typography-button-font-weight, 500);line-height:var(--forge-typography-button-line-height, normal);letter-spacing:var(--forge-typography-button-letter-spacing, .0714285714em);text-transform:var(--forge-typography-button-text-transform, inherit);text-decoration:var(--forge-typography-button-text-decoration, inherit);display:flex;align-items:center;gap:var(--forge-spacing-xsmall, 8px);border-radius:calc(var(--forge-shape-medium, 4px) * var(--forge-shape-factor, 1));background-color:var(--forge-theme-surface-container, #e0e0e0);padding-inline:var(--forge-spacing-medium, 16px);padding-block:var(--forge-spacing-xxsmall, 4px);color:var(--forge-theme-text-high, rgba(0, 0, 0, .87));cursor:pointer}.source svg{height:16px;width:16px}`;var H=Object.defineProperty,q=Object.getOwnPropertyDescriptor,y=(r,t,i,e)=>{for(var o=e>1?void 0:e?q(t,i):t,a=r.length-1,n;a>=0;a--)(n=r[a])&&(o=(e?n(t,i,o):n(o))||o);return e&&o&&H(t,i,o),o};const M="forge-ai-thought-search-result";let c=class extends u{constructor(){super(...arguments),this.sources=[]}render(){return s`
      <forge-ai-thought-base step=${x(this.step)}>
        ...
        <div class="sources-container">
          ${this.sources.map(r=>s`
              <a href="${r.href}" class="source" target="_blank" rel="noopener noreferrer">
                <span>${r.title}</span>
    ...
    `}};c.styles=g(B);y([d({type:Number})],c.prototype,"step",2);y([d({type:Array})],c.prototype,"sources",2);c=y([f(M)],c);const I=`/**
 * @license
 * Copyright Tyler Technologies, Inc. 
 * License: Apache-2.0
 */:host{display:block}.image-container{--forge-card-outline-color: transparent;display:grid;place-content:center;place-items:center}::slotted(img[slot=image]){height:150px;width:150px;object-fit:cover;border-radius:calc(var(--forge-shape-medium, 4px) * var(--forge-shape-factor, 1))}`;var S=Object.defineProperty,L=Object.getOwnPropertyDescriptor,k=(r,t,i,e)=>{for(var o=e>1?void 0:e?L(t,i):t,a=r.length-1,n;a>=0;a--)(n=r[a])&&(o=(e?n(t,i,o):n(o))||o);return e&&o&&S(t,i,o),o};const V="forge-ai-thought-image";let v=class extends u{render(){return s`
      <forge-ai-thought-base step=${x(this.step)}>
        <svg slot="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="forge-icon">
          <path
    ...
    `}};v.styles=g(I);k([d({type:Number})],v.prototype,"step",2);v=k([f(V)],v);const N=":host{display:block}";var G=Object.getOwnPropertyDescriptor,R=(r,t,i,e)=>{for(var o=e>1?void 0:e?G(t,i):t,a=r.length-1,n;a>=0;a--)(n=r[a])&&(o=n(o)||o);return o};const F="forge-ai-thought-detail";let m=class extends u{render(){return s`
      <forge-ai-thought-base>
        <svg slot="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="forge-icon">
    ...
    `}};m.styles=g(N);m=R([f(F)],m);const W="forge-ai-chain-of-thought",z=[{title:"Powder Safety Guide",href:"https://example.com/safety-guide"},{title:"Equipment Reviews 2024",href:"https://example.com/equipment-reviews"}],wo={title:"AI/Primitives/Chain of Thought",component:W,render:()=>s`
