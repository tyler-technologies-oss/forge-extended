import{x as t}from"./iframe-CjPB-dwZ.js";import{I as r,h as c,i as a,g as s,j as i,k as m}from"./icon-registry-BCb_k_Et.js";import"./multi-select-header-B3SFUofO.js";import{d}from"./index-Cfa9dMRV.js";import{d as f}from"./index-CTRqfxuJ.js";import{d as p}from"./index-BrPPItID.js";const{action:u}=__STORYBOOK_MODULE_ACTIONS__;d();f();p();r.define([c,a,s,i,m]);const g="forge-multi-select-header",x={title:"Components/Multi Select Header",component:g,render:o=>{const n=u("forge-multi-select-header-select-all"),l=[{label:"Export as a PDF",value:"option-1",icon:"file_pdf",leadingIconType:"component"},{label:"Export to Excel",value:"option-2",icon:"file_excel",leadingIconType:"component"}];return t`
