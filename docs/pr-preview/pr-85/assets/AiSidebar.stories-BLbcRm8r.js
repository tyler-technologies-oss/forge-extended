import{x as d}from"./iframe-B1Mvpz_X.js";import{I as c,d as p,e as l,f,g,h as m,i as h,j as u}from"./icon-registry-CgXURTcr.js";import{d as y}from"./ai-sidebar-CBIXmlYn.js";import"./ai-chat-interface-HIaCENGo.js";import"./ai-user-message-DXPJjKWz.js";import"./ai-response-message-IlcHLfXT.js";import"./ai-button-eqgksZhL.js";import{d as b}from"./index-C7KWgEBg.js";import{d as I}from"./index-UcjIgpty.js";const{action:r}=__STORYBOOK_MODULE_ACTIONS__;y();b();I();c.define([p,l,f,g,m,h,u]);const w="forge-ai-sidebar",x={title:"AI/Primitives/Sidebar",component:w,argTypes:{open:{control:{type:"boolean"},description:"Controls whether the sidebar is open"},expanded:{control:{type:"boolean"},description:"Controls whether the sidebar is displayed in an expanded state"}},args:{open:!1,expanded:!1},render:a=>{const t=r("forge-ai-sidebar-open"),i=r("forge-ai-sidebar-close"),s=()=>{const e=document.querySelector("forge-ai-chat-interface");e&&(e.expanded=!e.expanded)},n=()=>{document.querySelector("forge-ai-sidebar")?.close()};return d`
