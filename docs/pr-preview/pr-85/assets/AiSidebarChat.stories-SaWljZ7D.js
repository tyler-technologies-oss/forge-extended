import{r as E,i as T,x as n}from"./iframe-Dd8pSn9E.js";import{I as D,t as M,a as P,b as W,c as z,d as R,e as B,f as H}from"./icon-registry-m82pY_3b.js";import{t as N}from"./custom-element-BhZVzxrc.js";import{n as C}from"./property-BGv0PVOX.js";import{n as _,e as v}from"./ref-CTkuqqQn.js";import{n as q}from"./when-3fO0zp9C.js";import{d as L}from"./ai-sidebar-CE6dAEqc.js";import"./ai-chat-interface-C1fFXH_l.js";import"./ai-modal-BQ-6sd7b.js";import"./ai-user-message-D-EoHcTD.js";import"./ai-response-message-BazWVpVW.js";import"./ai-suggestions-Dlt0ZHXW.js";import"./ai-button-SYs-pLFy.js";import{d as F}from"./index-BncGQ5Cq.js";import{d as G}from"./index-vIJFja-l.js";import{d as K}from"./index-4GOAI1ui.js";const U=":host{display:block;height:100%}";var Y=Object.defineProperty,j=Object.getOwnPropertyDescriptor,w=e=>{throw TypeError(e)},x=(e,a,o,d)=>{for(var r=d>1?void 0:d?j(a,o):a,p=e.length-1,l;p>=0;p--)(l=e[p])&&(r=(d?l(a,o,r):l(r))||r);return d&&r&&Y(a,o,r),r},$=(e,a,o)=>a.has(e)||w("Cannot "+o),f=(e,a,o)=>($(e,a,"read from private field"),o?o.call(e):a.get(e)),g=(e,a,o)=>a.has(e)?w("Cannot add the same private member more than once"):a instanceof WeakSet?a.add(e):a.set(e,o),s=(e,a,o)=>($(e,a,"access private method"),o),u,b,t,y,I,S,A,O,k,i;const J="forge-ai-sidebar-chat";let c=class extends T{constructor(){super(...arguments),g(this,t),this.open=!1,this.expanded=!1,g(this,u,v()),g(this,b,v())}render(){return n`
      ${q(this.expanded,()=>n`
          <forge-ai-modal
            ${_(f(this,b))}
