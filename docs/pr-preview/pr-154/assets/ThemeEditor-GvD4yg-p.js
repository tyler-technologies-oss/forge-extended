import{j as e,M as i,T as o,C as h}from"./blocks-Ckl69VWd.js";import{useMDXComponents as s}from"./index-De36GQbW.js";import"./index-BFVZ7Xg9.js";import{T as d,D as a}from"./ThemeEditor.stories-D7HnXFPs.js";import"./iframe-B-hqvoN1.js";import"./_commonjsHelpers-CqkleIqs.js";import"./custom-element-C0MWYpx0.js";import"./utils-BpfZpwkX.js";import"./state-DJU2YaQu.js";import"./when-3fO0zp9C.js";import"./directive-CJw_OlP2.js";import"./style-map--KBZMGXr.js";import"./with-default-aria-UTb2ZfEa.js";import"./constants-BzUGdP7s.js";import"./checkbox-BOu_4c7k.js";import"./with-form-associated-CisgDCmJ.js";import"./base-button-adapter-D9nRSDVN.js";import"./focus-indicator-DAcdgG1c.js";import"./field-C0feFHP8.js";import"./button-constants-DFK1DSfd.js";import"./button-toggle-group-constants-DKuK54ky.js";import"./icon-button-DfhV15n1.js";import"./icon-y17Z_xfo.js";import"./index-QNvooWwG.js";import"./index-CEJh0Hxw.js";import"./circular-progress-C682riUh.js";import"./index-D9577PU0.js";import"./index-CTAqYqwJ.js";import"./index-CKzlr-_J.js";import"./index-lqWLPDYB.js";import"./linear-progress-constants-DGrLFOyv.js";import"./index-B653wrsF.js";import"./select-D-6gX3SY.js";import"./list-dropdown-aware-core-BxCWhu19.js";import"./list-1cByGSGC.js";import"./popover-NY4XGJLp.js";import"./with-longpress-listener-B_LXqv_X.js";import"./dismissible-stack-BCvcndys.js";import"./skeleton-constants-CuB2XE6P.js";import"./divider-B-AlEmoL.js";import"./scaffold-DirkK03f.js";import"./toolbar-B78QZkF-.js";import"./index-DP8T-jmX.js";import"./tooltip-XRL_YT2R.js";import"./index-BE5_aBI8.js";import"./index-BzNtNMlb.js";import"./index-Db49f7Dd.js";import"./index-BQrzhgsk.js";import"./index-BBUJRtX8.js";import"./index-CltcnWz3.js";import"./index-D5VChY-S.js";function n(r){const t={a:"a",code:"code",em:"em",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",pre:"pre",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...s(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(i,{of:d}),`
`,e.jsx(o,{}),`
...
`,e.jsx(t.h4,{id:"css-with-relative-colors",children:"CSS with relative colors"}),`
`,e.jsxs(t.p,{children:[e.jsx(t.code,{children:"exportTheme('css-relative')"}),` emits the same theme, but expresses every derived ramp
as a `,e.jsx(t.a,{href:"https://developer.mozilla.org/en-US/docs/Web/CSS/color_value#relative_colors",rel:"nofollow",children:"CSS relative color"}),`
of the token it came from, rather than freezing it at export time:`]}),`
...
`,e.jsxs(t.table,{children:[e.jsx(t.thead,{children:e.jsxs(t.tr,{children:[e.jsx(t.th,{children:"Name"}),e.jsx(t.th,{children:"Description"})]})}),e.jsxs(t.tbody,{children:[e.jsxs(t.tr,{children:[e.jsx(t.td,{children:e.jsx(t.code,{children:"getTheme()"})}),e.jsx(t.td,{children:"Returns the theme being edited."})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{children:e.jsx(t.code,{children:"loadTheme(theme)"})}),e.jsx(t.td,{children:"Replaces the theme, filling in anything the value omits."})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{children:e.jsx(t.code,{children:"exportTheme(format?)"})}),e.jsx(t.td,{children:"Emits the theme as JSON, Sass, CSS or relative-color CSS."})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{children:e.jsx(t.code,{children:"importTheme(text)"})}),e.jsx(t.td,{children:"Imports theme JSON and returns the warnings raised."})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{children:e.jsx(t.code,{children:"generatePalette(seeds?)"})}),e.jsx(t.td,{children:"Derives the full token set from seed colors."})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{children:e.jsx(t.code,{children:"setToken(token, value)"})}),e.jsx(t.td,{children:"Sets one token, or clears it when the value is empty."})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{children:e.jsx(t.code,{children:"resetToken(token)"})}),e.jsx(t.td,{children:"Reverts one token to the Forge default for the polarity."})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{children:e.jsx(t.code,{children:"resetAllTokens()"})}),e.jsx(t.td,{children:"Reverts every token in the active variant."})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{children:e.jsx(t.code,{children:"getContrastReport()"})}),e.jsxs(t.td,{children:["Returns every ",e.jsx(t.code,{children:"on-*"})," pair and its ratio, worst first."]})]})]})]}),`
