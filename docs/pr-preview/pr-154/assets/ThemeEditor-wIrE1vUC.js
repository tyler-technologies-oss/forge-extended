import{j as e,M as i,T as o,C as h}from"./blocks-D7B8mIrt.js";import{useMDXComponents as s}from"./index-De36GQbW.js";import"./index-BFVZ7Xg9.js";import{T as a,D as d}from"./ThemeEditor.stories-BWY6UyN_.js";import"./iframe-BKxBIIJQ.js";import"./_commonjsHelpers-CqkleIqs.js";import"./custom-element-BldoUTPl.js";import"./utils-B42KGafL.js";import"./state-CaY3QDV3.js";import"./when-3fO0zp9C.js";import"./directive-CJw_OlP2.js";import"./style-map-BHjVEl-t.js";import"./with-default-aria-DjItAXX6.js";import"./constants-aeBb4lYV.js";import"./checkbox-BdtP4wJG.js";import"./with-form-associated-nkehBhWJ.js";import"./base-button-adapter-B1QGS9Um.js";import"./focus-indicator-evqk8lHd.js";import"./field-BsgSpVj7.js";import"./button-constants-D3zZPESn.js";import"./button-toggle-group-constants-CncZbqKL.js";import"./icon-button-DNvrWAkH.js";import"./icon-CGdxk2in.js";import"./index-CBKvSyMs.js";import"./index-BTZl62sj.js";import"./circular-progress-CpuK6rKy.js";import"./index-DVopLR72.js";import"./index-0JZT0dcO.js";import"./index-gWwPKUeJ.js";import"./index-B4lkCY4V.js";import"./linear-progress-constants-D_6jO8mF.js";import"./index-Cv9UrVdU.js";import"./select-C2oOCVdg.js";import"./list-dropdown-aware-core-ODUd_dV0.js";import"./list-Ddtt4Jaf.js";import"./popover-BB3pmc-g.js";import"./with-longpress-listener-VROGiMiY.js";import"./dismissible-stack-DkTmbPfG.js";import"./skeleton-constants-2T5bCXss.js";import"./divider-DaKfdOPx.js";import"./scaffold-CCmKOYqB.js";import"./toolbar-Be9BG9fS.js";import"./index-B-WzmunU.js";import"./tooltip-C_fHynxG.js";import"./index-v3JyUmzH.js";import"./index-CbUPQDAC.js";import"./index-BaUYnTlJ.js";import"./index-DaaosOfI.js";import"./index-CIiglClF.js";import"./index-B9PZSlU1.js";import"./index-Cf-yF1Nt.js";function r(n){const t={a:"a",blockquote:"blockquote",code:"code",em:"em",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",pre:"pre",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...s(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(i,{of:a}),`
`,e.jsx(o,{}),`
...
`,e.jsx(t.h3,{id:"use-relative-css",children:"Use relative CSS"}),`
`,e.jsxs(t.p,{children:["The ",e.jsx(t.strong,{children:"Use relative CSS"})," checkbox sits with the generation controls on the ",e.jsx(t.strong,{children:"Palette"}),`
view, because it changes what generation produces. With it on, a derived ramp is
stored as a
`,e.jsx(t.a,{href:"https://developer.mozilla.org/en-US/docs/Web/CSS/Guides/Colors/Using_relative_colors",rel:"nofollow",children:"CSS relative color"}),`
...
`})}),`
`,e.jsxs(t.p,{children:[`That expression is the token's value — in the theme, in the editor, in the preview and
in the export. The `,e.jsx(t.strong,{children:"browser"}),` owns the derivation from then on, so changing
`,e.jsx(t.code,{children:"--forge-theme-primary"}),` moves every primary container with it, with no regeneration
anywhere. `,e.jsx(t.strong,{children:"40 of the 101 tokens"}),` work this way: all 28 accent containers, the 8-step
surface ramp and the 4 outline steps.`]}),`
`,e.jsxs(t.p,{children:[`The colors are computed first and then described, so an expression evaluates to
...
from, but a surface ramp is a lightness ramp, which is the part worth keeping. `,e.jsx(t.strong,{children:`An
...
`,e.jsxs(t.p,{children:[e.jsx(t.strong,{children:"The inks do not track."})," An ",e.jsx(t.code,{children:"on-"}),` color is the result of an iterative contrast
search, not a transform, so it cannot be expressed relatively and stays a flat value.
Change a base with relative colors on and the containers follow, but their `,e.jsx(t.code,{children:"on-"}),` inks
stay as they were — contrast can silently degrade. The `,e.jsx(t.strong,{children:"Contrast"}),` view is where that
...
`,e.jsx(t.strong,{children:"quiet"}),` failure — leave the option off if that matters. The CSS and Sass exports
carry the caveat in a comment when any token uses it.`]}),`
`,e.jsxs(t.p,{children:["A derived token's value belongs to its base, so on the ",e.jsx(t.strong,{children:"Tokens"}),` view those rows are
`,e.jsx(t.strong,{children:"read-only"}),` while the option is on — swatch, field and revert are all disabled, and
the row is marked. Editing one would only replace the expression with a literal and cut
the link, so turning the option off is the way to edit them directly. The `,e.jsx(t.code,{children:"on-"}),` inks
are never relative, so they stay editable.`]}),`
`,e.jsxs(t.p,{children:["Because swatches are ",e.jsx(t.code,{children:'<input type="color">'}),` and a contrast ratio is arithmetic, the
...
`,e.jsx(t.h3,{id:"saving-a-theme-1",children:"Saving a theme"}),`
`,e.jsx(t.p,{children:`There is no save button; persistence belongs to the host. Two ways to get the theme
out:`}),`
`,e.jsx(t.pre,{children:e.jsx(t.code,{className:"language-ts",children:`// Every edit, as it happens.
editor.addEventListener('forge-theme-editor-change', ({ detail }) => save(detail.theme));
...
`,e.jsx(t.code,{children:"theme.provide()"})," mixin and ",e.jsx(t.code,{children:"exportTheme('css')"})," a plain ",e.jsx(t.code,{children:":root"}),` block, for pasting
into an application directly.`]}),`
`,e.jsx(t.h4,{id:"use-relative-css-1",children:"Use relative CSS"}),`
...
`]})]})}function he(n={}){const{wrapper:t}={...s(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(r,{...n})}):r(n)}export{he as default};
