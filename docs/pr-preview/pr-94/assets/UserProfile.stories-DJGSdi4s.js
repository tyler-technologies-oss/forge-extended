import{c as fe,r as ge,i as pe,x as a,E as F}from"./iframe-DqYOlzIE.js";import{C as ue,B as ce,m as de,_ as he,l as me,h as ve,I as G,J as ye,K as be,L as _e,i as Oe,e as Se,f as Te}from"./with-default-aria-zNEsyQcs.js";import{M as U}from"./index-CWk7euD-.js";import{g as we}from"./_commonjsHelpers-CqkleIqs.js";import{e as H,n as J}from"./ref-DywzRkTL.js";import{n as c}from"./base-button-adapter-Bc7hf7-g.js";import{d as xe,r as Ee}from"./index-Bwr4q-c7.js";import{n as ke,a as O}from"./when-DfnyT8j1.js";import"./theme-toggle-DUUUSrAB.js";import"./profile-link-d6ZriGLk.js";import{d as Ce,a as Ae}from"./index-BSU0tfI6.js";import{d as Ie}from"./index-MJzaxMqd.js";import{d as $e}from"./index-CZ_xG77Z.js";import{d as De}from"./index-DXnTt6pY.js";import{d as Pe}from"./index-CA3GwYu3.js";/**
 * @license
 ...
 * Copyright Tyler Technologies, Inc. 
 * License: Apache-2.0
 */const Re='<template><div class="forge-divider" part="root"></div></template>',Me=":host{--_divider-margin:var(--forge-divider-margin, 0)}:host{display:block;margin:var(--_divider-margin)}:host([hidden]){display:none}.forge-divider{--_divider-color:var(--forge-divider-color, var(--forge-theme-outline, #e0e0e0));--_divider-width:var(--forge-divider-width, var(--forge-border-thin, 1px));--_divider-border-style:var(--forge-divider-border-style, solid)}.forge-divider{border:none;border-bottom-color:var(--_divider-color);border-bottom-width:var(--_divider-width);border-bottom-style:var(--_divider-border-style);height:0}:host([vertical]){display:inline-block;height:100%}:host([vertical]) .forge-divider{border:none;border-right-color:var(--_divider-color);border-right-width:var(--_divider-width);border-right-style:var(--_divider-border-style);height:100%;width:0}";let C=class extends ce{static get observedAttributes(){return[d.attributes.VERTICAL]}constructor(){super(),de(this,Re,Me)}attributeChangedCallback(e,r,o){switch(e){case d.attributes.VERTICAL:this.vertical=fe(o);break}}get vertical(){return this.hasAttribute(d.attributes.VERTICAL)}set vertical(e){this.toggleAttribute(d.attributes.VERTICAL,e)}};C=he([me({name:d.elementName})],C);/**
 * @license
 * Copyright Tyler Technologies, Inc. 
 * License: Apache-2.0
