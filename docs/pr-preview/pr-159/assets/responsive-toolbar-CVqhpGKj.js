var z=s=>{throw TypeError(s)};var C=(s,e,t)=>e.has(s)||z("Cannot "+t);var i=(s,e,t)=>(C(s,e,"read from private field"),t?t.call(s):e.get(s)),a=(s,e,t)=>e.has(s)?z("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(s):e.set(s,t),l=(s,e,t,r)=>(C(s,e,"write to private field"),r?r.call(s,t):e.set(s,t),t);import{t as _}from"./component-utils-DDaW1mI9.js";import{i as D,r as S,e as k,x}from"./iframe-CSr27Gi9.js";import{t as w,n as m}from"./utils-CaDkb-CY.js";import{e as R,n as E}from"./ref-CJF3Mb8J.js";import{d as B}from"./index-7VsvyswD.js";/**
 * @license
