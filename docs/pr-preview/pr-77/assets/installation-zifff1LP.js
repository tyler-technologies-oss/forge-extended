import{j as e,M as i}from"./blocks-jm6ffF5r.js";import{useMDXComponents as o}from"./index-CwZC63EC.js";import"./iframe-BHL0eVuP.js";import"./_commonjsHelpers-CqkleIqs.js";function t(r){const n={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...o(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(i,{title:"Getting Started/Installation"}),`
...
process to ensure they are defined with the browser before your application is rendered to avoid FOUC (Flash of Unstyled Content).`]})]})}function c(r={}){const{wrapper:n}={...o(),...r.components};return n?e.jsx(n,{...r,children:e.jsx(t,{...r})}):t(r)}export{c as default};
