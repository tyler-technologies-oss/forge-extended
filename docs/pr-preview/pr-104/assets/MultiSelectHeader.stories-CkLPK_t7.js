import{x as t}from"./iframe-CVNQnw_n.js";import{I as r,f as c,g as a,e as s,a as i,h as m}from"./with-default-aria-YnUymmup.js";import"./multi-select-header-Be5uzo2l.js";import{d}from"./index-B1lUAh7d.js";import{d as f}from"./index-BKePeJ-r.js";import{d as p}from"./index-OcvsHiQW.js";const{action:u}=__STORYBOOK_MODULE_ACTIONS__;d();f();p();r.define([c,a,s,i,m]);const g="forge-multi-select-header",x={title:"Components/Multi Select Header",component:g,render:o=>{const n=u("forge-multi-select-header-select-all"),l=[{label:"Export as a PDF",value:"option-1",icon:"file_pdf",leadingIconType:"component"},{label:"Export to Excel",value:"option-2",icon:"file_excel",leadingIconType:"component"}];return t`
