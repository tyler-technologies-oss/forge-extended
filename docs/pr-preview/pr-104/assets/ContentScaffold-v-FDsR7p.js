import{j as e,M as i,T as r,C as l}from"./blocks-CFDNBWMM.js";import{useMDXComponents as s}from"./index-De36GQbW.js";import"./index-BFVZ7Xg9.js";import{C as d,D as a}from"./ContentScaffold.stories-Dju_CugH.js";import"./iframe-BxKkWUAw.js";import"./_commonjsHelpers-CqkleIqs.js";import"./content-scaffold-BwTR8TXa.js";import"./constants-Bb7Ji_uf.js";import"./when-DfnyT8j1.js";import"./base-CShCMygk.js";import"./async-directive-BuvWFHC9.js";import"./directive-CJw_OlP2.js";import"./index-zGCrOJ37.js";import"./toolbar-MYMqhbyN.js";function o(n){const t={blockquote:"blockquote",code:"code",h2:"h2",h3:"h3",li:"li",p:"p",strong:"strong",ul:"ul",...s(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(i,{of:d,tags:["hidden"]}),`
`,e.jsx(r,{}),`
...
`,e.jsx(t.p,{children:"The Content Scaffold supports two layout modes for headers and footers:"}),`
`,e.jsx(t.h3,{id:"full-width-mode-recommended-for-complex-layouts",children:"Full-Width Mode (Recommended for Complex Layouts)"}),`
`,e.jsxs(t.p,{children:["When ",e.jsx(t.code,{children:"full-width-header"})," or ",e.jsx(t.code,{children:"full-width-footer"})," is enabled, you have complete control over the layout:"]}),`
`,e.jsxs(t.ul,{children:[`
`,e.jsxs(t.li,{children:[e.jsx(t.strong,{children:"header"})," - Full-width header content slot (when ",e.jsx(t.code,{children:"full-width-header"})," is true)"]}),`
`,e.jsxs(t.li,{children:[e.jsx(t.strong,{children:"body"})," - Main content area that expands to fill available space (1fr)"]}),`
`,e.jsxs(t.li,{children:[e.jsx(t.strong,{children:"footer"})," - Full-width footer content slot (when ",e.jsx(t.code,{children:"full-width-footer"})," is true)"]}),`
`]}),`
`,e.jsx(t.h3,{id:"standard-mode-built-in-layout",children:"Standard Mode (Built-in Layout)"}),`
`,e.jsx(t.p,{children:"When full-width mode is not enabled, the component provides a built-in toolbar layout with multiple slots:"}),`
`,e.jsxs(t.ul,{children:[`
...
`,e.jsxs(t.li,{children:["By default, sections are separated by a medium spacing gap (controlled via ",e.jsx(t.code,{children:"--forge-content-scaffold-gap"}),")"]}),`
`]}),`
...
`,e.jsxs(t.ul,{children:[`
`,e.jsxs(t.li,{children:[e.jsx(t.code,{children:"--forge-content-scaffold-gap"})," - Controls the gap between header, body, and footer sections. Defaults to Forge's medium spacing token."]}),`
...
`,e.jsxs(t.li,{children:[e.jsx(t.code,{children:"--forge-content-scaffold-body-padding"})," - Controls the padding applied to the body section. Defaults to Forge's small spacing token."]}),`
...
`]}),`
`,e.jsx(t.h2,{id:"api",children:"API"})]})}function S(n={}){const{wrapper:t}={...s(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(o,{...n})}):o(n)}export{S as default};
