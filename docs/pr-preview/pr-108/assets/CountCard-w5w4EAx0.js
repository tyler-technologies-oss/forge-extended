import{j as e,M as i,T as d,C as o}from"./blocks-B-PZX6_Q.js";import{useMDXComponents as r}from"./index-De36GQbW.js";import{C as c}from"./CustomArgTypes-D2mJe_Zj.js";import{C as l,D as a}from"./CountCard.stories-BZ07Tyc5.js";import{MultipleCards as h}from"./MultipleCards.stories-D4AzmyiN.js";import{CustomIconStyles as x}from"./CustomIconStyles.stories-BIQXmJRu.js";import{WithoutIcon as j}from"./WithoutIcon.stories-D5hzvtJd.js";import{WithFullBleed as u}from"./WithFullBleed.stories-9JgmuexC.js";import{WithCountBadge as p}from"./WithCountBadge.stories-CggDvlde.js";import"./iframe-COytv9dl.js";import"./index-BFVZ7Xg9.js";import"./_commonjsHelpers-CqkleIqs.js";import"./utils-CKXO1qFu.js";import"./icon-registry-CxyCioWM.js";import"./base-lit-element--sa9p8lJ.js";import"./count-badge-ey9Li0gP.js";import"./async-directive-Xvh01PSI.js";import"./directive-CJw_OlP2.js";import"./index-9Q7z6kh-.js";import"./index-B2zzxblL.js";import"./icon-QN_BHm4s.js";function s(t){const n={code:"code",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...r(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(i,{of:l}),`
`,e.jsx(d,{}),`
...
`,e.jsx(n.p,{children:"The Count Card uses a slot-based architecture with five main areas:"}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"full-bleed"})," - Optional full-width content below the primary card content, ideal for sparklines, meters, or progress indicators"]}),`
`]}),`
...
`,e.jsx(o,{of:h}),`
`,e.jsx(n.h3,{id:"custom-icon-styles",children:"Custom Icon Styles"}),`
`,e.jsx(n.p,{children:"Use CSS custom properties to customize the icon container appearance."}),`
`,e.jsx(o,{of:x}),`
...
`,e.jsx(o,{of:j}),`
`,e.jsx(n.h3,{id:"with-full-bleed-content",children:"With Full Bleed Content"}),`
`,e.jsxs(n.p,{children:["Use the ",e.jsx(n.code,{children:"full-bleed"})," slot to add full-width content below the primary card content. This is ideal for sparklines, meters, progress bars, or any visualization that should span the entire width of the card."]}),`
`,e.jsx(o,{of:u}),`
...
`,e.jsx(c,{})]})}function A(t={}){const{wrapper:n}={...r(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(s,{...t})}):s(t)}export{A as default};
