import{r as C,i as I,x as b}from"./iframe-Bc1gK1D2.js";import{t as O}from"./constants-C0oGLkIs.js";import{I as S,O as $,P as T,z as h}from"./with-default-aria-DKBtCCS8.js";import{e as D}from"./base-CShCMygk.js";import{d as z}from"./index-BEa2pFwo.js";import{d as L}from"./index-DeunrSu9.js";import{d as P}from"./index-DzKHyiTq.js";/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Q(e){return(t,o)=>{const{slot:n,selector:r}={},c="slot"+(n?`[name=${n}]`:":not([name])");return D(t,o,{get(){const p=this.renderRoot?.querySelector(c),v=p?.assignedElements(e)??[];return r===void 0?v:v.filter((E=>E.matches(r)))}})}}const F=`/**
 * @license
