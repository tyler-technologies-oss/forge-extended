import{j as e,M as i,T as r,C as s}from"./blocks-CIk4330a.js";import{useMDXComponents as a}from"./index-De36GQbW.js";import{C as l}from"./CustomArgTypes-Jg_giO2B.js";import{A as c,D as p}from"./AppLayout.stories-Bq46JMvC.js";import"./iframe-DOl2emF7.js";import"./index-BFVZ7Xg9.js";import"./_commonjsHelpers-CqkleIqs.js";import"./utils-V9M-paan.js";import"./if-defined-dcmkgF62.js";import"./app-layout-3e_uRheM.js";import"./when-DfnyT8j1.js";import"./base-CShCMygk.js";import"./constants-BAgjIeEf.js";import"./with-default-aria-CiOE7Mlp.js";import"./state-LDpi-q4E.js";import"./index-ErtbTvYY.js";import"./scaffold-tzj8evld.js";import"./index-vxrdqo9g.js";import"./dismissible-stack-BnNWEYOR.js";import"./list-BM1OugYt.js";import"./index-CSFDtbaJ.js";import"./icon-button-DdJNVDcH.js";import"./base-button-adapter-I47VxOPp.js";import"./index-BOQYXO1V.js";import"./tooltip-BACUBJKf.js";import"./with-longpress-listener-OF7OuqUu.js";import"./index-DHQBDRLC.js";import"./index-Bms_YPRM.js";import"./index-DHC73bQO.js";import"./index-lC_XXeA5.js";function o(t){const n={blockquote:"blockquote",code:"code",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...a(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(i,{of:c}),`
`,e.jsx(r,{}),`
...
`})}),`
`,e.jsxs(n.p,{children:["You can also programmatically open or close the drawer using the ",e.jsx(n.code,{children:"openDrawer()"})," and ",e.jsx(n.code,{children:"closeDrawer()"})," methods:"]}),`
...
`]}),`
`,e.jsx(n.h2,{id:"hiding-the-app-bar",children:"Hiding the App Bar"}),`
`,e.jsxs(n.p,{children:["In some cases, you may want to use the app-layout component without the built-in app bar, such as when embedding the layout within another application or using a custom header. You can hide the app bar by setting the ",e.jsx(n.code,{children:"no-app-bar"})," attribute:"]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-html",children:`<forge-app-layout no-app-bar>
  <!-- Custom header content in the header slot -->
  <div slot="header">
...
`})}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Note:"})," When the app bar is hidden, the built-in menu button for toggling the navigation drawer on small screens will also be hidden. You will need to provide your own button and use the ",e.jsx(n.code,{children:"openDrawer()"})," method to open the navigation drawer on small screens."]}),`
`]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-html",children:`<forge-app-layout id="app-layout" no-app-bar>
  <forge-app-bar slot="header">
    <!-- Custom menu button to open the drawer -->
    <forge-icon-button slot="start" id="menu-button" aria-label="Open navigation">
...
<\/script>
`})}),`
`,e.jsx(n.h2,{id:"layout-presets",children:"Layout Presets"}),`
`,e.jsxs(n.p,{children:["The ",e.jsx(n.code,{children:"preset"})," property allows you to configure the app-layout for different application types. Each preset applies a CSS state that can be used for targeted styling."]}),`
`,e.jsx(n.h3,{id:"available-presets",children:"Available Presets"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"backoffice"})," (default): For internal business applications and administrative interfaces"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"public"}),": For public-facing applications and customer portals"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"documentation"}),": For documentation sites and knowledge bases (app bar is not rendered)"]}),`
`]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-html",children:`<!-- Default backoffice preset -->
<forge-app-layout app-title="Admin Dashboard">
  <!-- ... -->
</forge-app-layout>

<!-- Public-facing application -->
<forge-app-layout app-title="Customer Portal" preset="public">
  <!-- ... -->
</forge-app-layout>

<!-- Documentation site -->
<forge-app-layout app-title="Developer Docs" preset="documentation">
  <!-- ... -->
</forge-app-layout>
`})}),`
`,e.jsx(n.h3,{id:"styling-based-on-preset",children:"Styling Based on Preset"}),`
`,e.jsx(n.p,{children:"You can use CSS custom states to apply preset-specific styles:"}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-css",children:`forge-app-layout:state(backoffice) {
  /* Styles for backoffice preset */
}

forge-app-layout:state(public) {
  /* Styles for public preset */
}

forge-app-layout:state(documentation) {
  /* Styles for documentation preset */
}
`})}),`
...
`]})]})}function R(t={}){const{wrapper:n}={...a(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(o,{...t})}):o(t)}export{R as default};
