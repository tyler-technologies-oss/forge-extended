import{r as R,i as E,a as k,x as S}from"./iframe-DOl2emF7.js";import{t as D}from"./constants-BAgjIeEf.js";import{u as b,x as _}from"./with-default-aria-CiOE7Mlp.js";import{n as C,e as y}from"./ref-DWlgHsLQ.js";import{d as x}from"./index-CfEGdxST.js";/**
 * @license
 ...
 */:host{display:block;position:relative}forge-toolbar[auto-height]{--forge-toolbar-min-height: var(--forge-toolbar-height, 56px)}#end-small,#end-large{margin-inline-start:var(--forge-spacing-medium, 16px)}[slot=start]{padding-block:var(--forge-spacing-xxxsmall, 2px)}:host(:state(small)) #end-large,:host(:state(large)) #end-small{visibility:hidden;position:absolute}`;var T=Object.defineProperty,W=Object.getOwnPropertyDescriptor,w=t=>{throw TypeError(t)},m=(t,e,s,i)=>{for(var a=i>1?void 0:i?W(e,s):e,d=t.length-1,c;d>=0;d--)(c=t[d])&&(a=(i?c(e,s,a):c(a))||a);return i&&a&&T(e,s,a),a},z=(t,e,s)=>e.has(t)||w("Cannot "+s),o=(t,e,s)=>(z(t,e,"read from private field"),s?s.call(t):e.get(t)),r=(t,e,s)=>e.has(t)?w("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,s),p=(t,e,s,i)=>(z(t,e,"write to private field"),e.set(t,s),s),u,f,v,n,g,l;const $=24,I=100,M="forge-responsive-toolbar";let h=class extends E{constructor(){super(),this.noBorder=!1,this.inverted=!1,this.resizeDelay=I,r(this,u,y()),r(this,f,y()),r(this,v),r(this,n),r(this,g),r(this,l),p(this,v,this.attachInternals())}disconnectedCallback(){var t;p(this,g,void 0),(t=o(this,l))==null||t.call(this),super.disconnectedCallback()}willUpdate(t){t.has("resizeDelay")&&this.resizeDelay!==t.get("resizeDelay")&&(o(this,n)&&(o(this,n).unobserve(this),this.removeController(o(this,n))),this._initializeResizeController())}_initializeResizeController(){var t;(t=o(this,l))==null||t.call(this),p(this,l,k(()=>requestAnimationFrame(()=>this._handleResize()),this.resizeDelay)),p(this,n,new O(this,{callback:o(this,l)}))}_handleResize(){const t=o(this,u).value?.getBoundingClientRect().right||0,e=o(this,f).value?.getBoundingClientRect().left||0,i=t+$>=e?"small":"large";o(this,g)!==i&&(p(this,g,i),_(o(this,v),"small",i==="small"),_(o(this,v),"large",i==="large"),this._emitOverflowEvent(i))}_emitOverflowEvent(t){const e=new CustomEvent("forge-responsive-toolbar-update",{bubbles:!0,composed:!0,cancelable:!0,detail:{state:t}});this.dispatchEvent(e)}render(){return S`
    ...
    `}};u=new WeakMap;f=new WeakMap;v=new WeakMap;n=new WeakMap;g=new WeakMap;l=new WeakMap;x();h.styles=R(B);m([b({type:Boolean,attribute:"no-border"})],h.prototype,"noBorder",2);m([b({type:Boolean})],h.prototype,"inverted",2);m([b({type:Number,attribute:"resize-delay"})],h.prototype,"resizeDelay",2);h=m([D(M)],h);
