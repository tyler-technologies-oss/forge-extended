import{r as C,i as I,x as b}from"./iframe-BLBGr_e1.js";import{t as S}from"./constants-BWeQaIEx.js";import{I as O,A as $,C as T,u as h}from"./with-default-aria-j9_2aAXy.js";import{e as D}from"./base-CShCMygk.js";import{d as L}from"./index-kAhcI0l0.js";import{d as z}from"./index-C6kC5_it.js";import{d as Q}from"./index-JAfPDPI_.js";/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function A(e){return(t,o)=>{const{slot:n,selector:r}={},c="slot"+(n?`[name=${n}]`:":not([name])");return D(t,o,{get(){const p=this.renderRoot?.querySelector(c),v=p?.assignedElements(e)??[];return r===void 0?v:v.filter((E=>E.matches(r)))}})}}const F=`/**
 * @license
