import{j as e,M as a}from"./blocks-CHX6097g.js";import{useMDXComponents as t}from"./index-De36GQbW.js";import"./iframe-ULyB_0Dy.js";import"./index-BFVZ7Xg9.js";import"./_commonjsHelpers-CqkleIqs.js";function o(r){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...t(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(a,{title:"Migration/Landing Page Layout"}),`
...
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Header gradient:"})," the default header background is a fixed blue/indigo gradient rather than one derived from the current theme's tertiary and primary colors. Override with the new ",e.jsx(n.code,{children:"--forge-landing-page-layout-header-gradient-start"})," and ",e.jsx(n.code,{children:"--forge-landing-page-layout-header-gradient-end"})," CSS custom properties to bring the theme-derived gradient (or any other pair of colors) back."]}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Background image overlay:"})," when a background image is present, a darkening gradient overlay (denser at the top, lighter at the bottom) is layered over it instead of dimming the image itself. Header content contrast is preserved without washing out image detail. Tune the top and bottom colors with the new ",e.jsx(n.code,{children:"--forge-landing-page-layout-header-overlay-start"})," and ",e.jsx(n.code,{children:"--forge-landing-page-layout-header-overlay-end"})," CSS custom properties."]}),`
`]}),`
