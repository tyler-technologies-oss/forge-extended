...
You can also programmatically control the left navigation drawer using these methods:
...
> **Note:** These methods only have an effect on small screens where the drawer is modal. On large screens, the left navigation drawer is always visible.
