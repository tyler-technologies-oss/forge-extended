...
> **Note:** When the app bar is hidden, the built-in menu button for toggling the navigation drawer on small screens will also be hidden. You will need to provide your own mechanism for opening the navigation drawer on small screens if needed.
