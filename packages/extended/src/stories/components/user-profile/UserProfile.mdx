...
- For internationalization, the `theme-toggle-aria-label` attribute lets you translate the theme toggle group's ARIA label, and the `theme-toggle-title`, `theme-toggle-light-label`, `theme-toggle-dark-label`, and `theme-toggle-system-label` slots let you translate the theme toggle's title and option text.
