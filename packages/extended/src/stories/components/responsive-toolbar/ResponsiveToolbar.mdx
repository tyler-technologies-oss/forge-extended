...
The `<forge-responsive-toolbar>` should be used in areas of your application that you know will be used on devices with lower resolutions, or mobile devices.
