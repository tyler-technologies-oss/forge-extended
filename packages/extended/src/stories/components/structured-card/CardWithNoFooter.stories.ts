...
import { tylIconDelete, tylIconShare, tylIconMoreVert, tylIconDownload, tylIconEdit } from '@tylertech/tyler-icons';
...
defineIconComponent();
defineMenuComponent();
IconRegistry.define([tylIconDelete, tylIconShare, tylIconMoreVert, tylIconDownload, tylIconEdit]);
...
export const CardWithNoFooter: Story = {};
