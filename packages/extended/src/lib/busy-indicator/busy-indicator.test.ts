...
describe('Busy Indicator', () => {
  it('should contain shadow root', async () => {
    const el = await fixture<BusyIndicatorComponent>(html`<forge-busy-indicator></forge-busy-indicator>`);
  ...
  it('should set open attribute', async () => {
    const el = await fixture<BusyIndicatorComponent>(html`<forge-busy-indicator open></forge-busy-indicator>`);
  ...
  it('should set title text attribute', async () => {
    const el = await fixture<BusyIndicatorComponent>(
  ...
  it('should set cancelable attribute', async () => {
    const el = await fixture<BusyIndicatorComponent>(html`<forge-busy-indicator cancelable></forge-busy-indicator>`);
  ...
  it('should set spinner attribute', async () => {
    const el = await fixture<BusyIndicatorComponent>(html`<forge-busy-indicator spinner></forge-busy-indicator>`);
  ...
  it('should set progress bar attribute', async () => {
    const el = await fixture<BusyIndicatorComponent>(html`<forge-busy-indicator progress-bar></forge-busy-indicator>`);
  ...
  it('should set progress attribute', async () => {
    const el = await fixture<BusyIndicatorComponent>(html`<forge-busy-indicator progress=".5"></forge-busy-indicator>`);

    expect(el.progress).to.equal(0.5);
  });

  it('should set buffer attribute', async () => {
    const el = await fixture<BusyIndicatorComponent>(html`<forge-busy-indicator buffer=".6"></forge-busy-indicator>`);
  ...
  it('should set direction attribute', async () => {
    const el = await fixture<BusyIndicatorComponent>(
      html`<forge-busy-indicator direction="row"></forge-busy-indicator>`
    );
  ...
  it('should dispatch cancel event', async () => {
    const el = await fixture<BusyIndicatorComponent>(
      html`<forge-busy-indicator open cancelable></forge-busy-indicator>`
    );
