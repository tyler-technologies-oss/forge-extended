    ...
    return html`
      <div class="grid-container">
        ...
        <div class="actions-toolbar">
          <button aria-label="Refresh" class="forge-icon-button forge-icon-button--medium">
          ...
          <button aria-label="Copy content" class="forge-icon-button forge-icon-button--medium">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              <path
                d="M19 21H8V7h11m0-2H8a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h11a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2m-3-4H4a2 2 0 0 0-2 2v14h2V3h12z" />
            </svg>
          </button>
          <button aria-label="Thumbs up" class="forge-icon-button forge-icon-button--medium">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              <path
          ...
          <button aria-label="Thumbs down" class="forge-icon-button forge-icon-button--medium">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              <path
