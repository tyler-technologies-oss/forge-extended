...
import { AiActionsToolbarComponent, type AiActionsToolbarActionEventData } from './ai-actions-toolbar';
...
describe('AiActionsToolbar', () => {
  ...
  it('should emit action events when buttons are clicked', async () => {
    ...
    let eventDetail: AiActionsToolbarActionEventData;
    el.addEventListener('forge-ai-actions-toolbar-action', (evt: CustomEvent<AiActionsToolbarActionEventData>) => {
