...
import { ForgeRteAlign as ForgeRteAlignElement } from "@tylertech/forge-extended/rich-text-editor/features";

export type { ForgeRteAlignElement };

export interface ForgeRteAlignProps
  extends Pick<
 ...
 *
 */
export const ForgeRteAlign: React.ForwardRefExoticComponent<ForgeRteAlignProps>;
