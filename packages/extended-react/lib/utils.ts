...
export type ElementProxyProps<T> =
  | Partial<Omit<T, 'children'>>
  | { style?: Partial<CSSStyleDeclaration> }
  | { [key: string]: any };
export type ElementProxy<T> = ForwardRefExoticComponent<
  PropsWithRef<ElementProxyProps<T>> & { children?: React.ReactNode } & React.RefAttributes<unknown>
>;
