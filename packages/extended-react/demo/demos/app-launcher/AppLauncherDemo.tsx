...
import { tylIconPayment, tylIconAccountBalance, tylIconDashboard, tylIconCalculate, tylIconReportProblem, tylIconHomeWork, tylIconSecurity, tylIconAdminPanelSettings, tylIconBatchPrediction } from '@tylertech/tyler-icons';
import { useState } from 'react';

IconRegistry.define([tylIconPayment, tylIconAccountBalance, tylIconDashboard, tylIconCalculate, tylIconReportProblem, tylIconHomeWork, tylIconSecurity, tylIconAdminPanelSettings, tylIconBatchPrediction]);
...
const relatedAppsData = [
  { label: 'Payments Administration', iconName: 'payment', uri: 'https://example.com/payments-admin', target: '_blank' },
  { label: 'PEP Administration', iconName: 'admin_panel_settings', uri: 'https://example.com/pep-admin', target: '_blank' },
