...
class ChromeLauncher {
    constructor(launchOptions, createBrowserContextFn, createPageFn, customPuppeteer, concurrency) {
        ...
        else if (!((_a = this.launchOptions) === null || _a === void 0 ? void 0 : _a.browser) || this.launchOptions.browser === 'chrome') {
    ...
    async createNewPage(browser, context) {
        ...
        return new ChromeLauncherPage_js_1.ChromeLauncherPage(this.config, this.testFiles, (_b = (_a = this.launchOptions) === null || _a === void 0 ? void 0 : _a.browser) !== null && _b !== void 0 ? _b : 'chromium', await puppeteerPagePromise);
    }
